...
up:
	...
	@sudo sh -c 'echo "127.0.0.1 amontalb.fr" >> /etc/hosts && echo "successfully added amontalb.fr to /etc/hosts"'
...
clean:
	...
	@sudo sed -i '/127.0.0.1 amontalb.fr/d' /etc/hosts && echo "successfully removed amontalb.fr to /etc/hosts"
